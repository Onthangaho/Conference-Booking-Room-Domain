...
// This component fetches and displays the details of a specific booking based on the provided bookingId. It handles loading and not-found states gracefully, showing appropriate messages to the user.
